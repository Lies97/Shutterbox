...
class MainDemo extends Component {
  ...
  render() {
    ...
    const className = isLoading
      ? 'home-demo-wrapper disabled'
      : 'home-demo-wrapper';
    const PostList = BlogContent.slice(0, 3);
    return isLoading ? (
      <Loading className="middle" />
    ) : (
      <Animate
        animationIn="fadeIn"
      ...
      >
        <div className={className}>
          <Helmet pageTitle="Shutterbox - Creative Factory" />
          ...
          <div className="rn-testimonial-area bg_color--1 ptb--120">
            <div className="container">{!isLoading && <Testimonial />}</div>
          </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(MainDemo);
